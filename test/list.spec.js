...
import { mdcList } from '../packages/mcwv-list/index.js';

const Spec = {
  template: `  <div>
<mdc-list-group>
  <mdc-list-group-sub-header>Group 1</mdc-list-group-sub-header>
  <mdc-list>
  ...
  <mdc-list-divider />
  <mdc-list-group-sub-header>Group 2</mdc-list-group-sub-header>
  <mdc-list>
