  ...
  <div class="mcw-demo">
    ...
    >
      ...
      <mcw-dialog-footer>
        ...
        <mcw-dialog-button action="accept" is-default is-initial-focus>Accept</mcw-dialog-button>
      </mcw-dialog-footer>
    </mcw-dialog>
    ...
    >
      ...
      <mcw-dialog-footer>
        ...
        <mcw-dialog-button action="discard" is-default>Discard</mcw-dialog-button>
      </mcw-dialog-footer>
    </mcw-dialog>
        ...
        <mcw-list single-selection>
          ...
          >
            <span class="mdc-list-item__graphic">
              <mcw-radio :id="choice | clean" v-model="picked" name="ringtone" :value="choice"></mcw-radio>
            </span>
